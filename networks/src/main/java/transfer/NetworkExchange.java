 ...
 * all type of code. It depends on previous request.
 * */
...
public static final int RESPONSE_COMPACT_FORMAT = 0b01;
public static final int RESPONSE_VERBOSE_FORMAT = 0b10;
public static final int TRANSFER_ATTACHED_FORMAT = 0b1_00;
public static final int TRANSFER_POLLED_FORMAT = 0b10_00; //after common message (in NetworkPackage) also binary data is available
...
private NetworkPacket.PacketDirection direction;
