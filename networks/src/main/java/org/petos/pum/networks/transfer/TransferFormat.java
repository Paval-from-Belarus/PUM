...
public record TransferFormat(PackageAssembly.ArchiveType archive, Encryption encryption) {
...
public static TransferFormat construct(byte[] bytes) {
      ...
      PackageAssembly.ArchiveType archive = PackageAssembly.ArchiveType.values()[buffer.getInt()];
...
public static TransferFormat valueOf(PackageAssembly.ArchiveType archive, Encryption encryption) {
